...
<head>
	...
	<script type="text/javascript" src="peticion_solicitud2.js"></script>
</head>
<body>
	  <div id="contenedor">
		...
		<div id="datos">
			<form id="form1" class="sinestilo" method="post" action="eliminar.php">
				<span id="tabla_resultado"></span>
				<input type="submit" class="eliminar" name="eliminar" value="Eliminar" onclick="eliminar_solicitud();">
				<input type="submit" class="eliminar" name="modificar" value="Modificar" onclick="contar_solicitud();">
			</form>
		</div>
		</div>
