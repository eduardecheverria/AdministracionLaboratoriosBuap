...
<body>
	<div id="contenedor">
		...
		<div>
			<form action="mod-alumno.php" method="POST" onsubmit="return validar()">
			<h2>Modificar</h2>
			...
			<select  id="carrera" placeholder="Carrera" name="carrera" >
				 <option value="">Carrera</option>
				 <option <?php if($row[6]=="ITI"){echo "selected";} ?> value="ITI">ITI</option>
				 <option <?php if($row[6]=="Ingenieria"){echo "selected";} ?> value="Ingenieria">Ingenieria</option>
			     <option <?php if($row[6]=="Licenciatura"){echo "selected";} ?> value="Licenciatura">Licenciatura</option>
			</select>
